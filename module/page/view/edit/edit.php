<form method="post">
	<div class="row">
		<div class="col6">
			<div class="block">
				...
				<div class="row">
					<?php if(empty($this->getHierarchy($this->getUrl(0)))): ?>
						<div class="col6">
							<?php echo template::select('pageEditParentPageId', $module::$pagesNoParentId, [
								'label' => 'page parent',
								'selected' => $this->getData(['page', $this->getUrl(0), 'parentPageId'])
							]); ?>
						</div>
						<div class="col6">
					<?php else: ?>
			...
			<div class="block">
				...
				<div class="row">
					<div class="col10">
						...
						<?php echo template::select('pageEditModuleId', helper::arrayCollumn($this->getData(['page']), 'title', 'SORT_ASC'), [
	...
	<div class="row">
		...
		<div class="col2">
			<?php echo template::submit('pageEditSave'); ?>
		</div>
	</div>
</form>