...
$("input, select").on("change", function() {
	...
	css += ".speechBubble,.button,button[type='submit'],.pagination a,input[type='checkbox']:checked + label:before,.helpContent{background-color:" + colors.normal + ";color:" + colors.text + "}";
